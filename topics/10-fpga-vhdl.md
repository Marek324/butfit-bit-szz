...
- **Configurable Logic Blocks (CLB)** — z více *slice*; obsahují:
  ...
  - **klopný obvod typu D** — paměť pro [[topics/03-sekvencni-logicke-obvody|sekvenční obvody]].
...
- Postup **shora dolů**: dekompozice problému na jednoduché komponenty ([[topics/02-kombinacni-logicke-obvody|sčítačka]], registr, čítač), verifikace na každé úrovni.
- Metodologie **RT (register transfer)**: stavový automat → datová cesta (datapath) → řídicí signály → řídicí [[topics/03-sekvencni-logicke-obvody|Mealy/Moore automat]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/09-reprezentace-cisel-ieee754|9. Reprezentace čísel]] · další: [[topics/11-2d-vektorova-grafika|11. 2D vektorová grafika]] ▶

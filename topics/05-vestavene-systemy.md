...
relationships:
  - target: "[[topics/06-periferie-preruseni-dma-sbernice]]"
    type: related_to
...
Instrukční sada [[topics/07-princip-cinnosti-pocitace-pipelining|RISC × CISC]].
...
- **ADC** (analogově-číslicový): **Flash ADC** (kombinační, $2^N-1$ [[topics/02-kombinacni-logicke-obvody|komparátorů]] + prioritní kodér, rychlý, drahý); **aproximační ADC** (sekvenční, SAR, půlení intervalů, $O(N)$).
...
Displej (7segment), klávesnice (dělič napětí + ADC, nebo kodér), motory/LED/bzučák přes **PWM** (řízení střídy) nebo DAC. Připojování a obsluhu řeší podrobně [[topics/06-periferie-preruseni-dma-sbernice]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/04-hierarchie-pameti|4. Hierarchie paměti]] · další: [[topics/06-periferie-preruseni-dma-sbernice|6. Připojování periferií]] ▶

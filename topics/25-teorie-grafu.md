...
relationships:
  - target: "[[topics/16-mnoziny-relace-zobrazeni]]"
    type: related_to
  - target: "[[topics/44-smerovani-zabezpeceni-siti]]"
    type: related_to
...
Grafy jako relace viz [[topics/16-mnoziny-relace-zobrazeni]]; prohledávání viz [[topics/26-reseni-uloh-prohledavani]]; Dijkstra v [[topics/44-smerovani-zabezpeceni-siti|Link-State směrování]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/24-numericke-metody|24. Numerické metody]] · další: [[topics/26-reseni-uloh-prohledavani|26. Řešení úloh (prohledávání)]] ▶

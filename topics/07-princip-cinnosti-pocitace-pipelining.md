...
Latence paměti řeší [[topics/04-hierarchie-pameti|cache]]; architektura MCU a volba RISC/CISC viz [[topics/05-vestavene-systemy]]; přerušení jako řídicí hazard viz [[topics/06-periferie-preruseni-dma-sbernice]]; sčítačky v ALU viz [[topics/02-kombinacni-logicke-obvody]].
...
Situace, které je nutné při řetězení instrukcí řešit, jinak by mohl být výsledek výpočtů nesprávný. Často konflikty způsobují **zpomalení** linky (**stall**) linka musí čekat na **dokončení** některé instrukce. Někdy stačí, když překladač změní pořadí **nezávislých** instrukcí pro vyřešení konfliktu. Konflikty dělíme na:
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/06-periferie-preruseni-dma-sbernice|6. Připojování periferií]] · další: [[topics/08-minimalizace-logickych-vyrazu|8. Minimalizace logických výrazů]] ▶

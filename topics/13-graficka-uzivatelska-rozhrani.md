...
- HW realizace přes [[topics/06-periferie-preruseni-dma-sbernice|přerušení]]; SW: event listeners, callbacks, Qt signals & slots.
...
Vykreslení prvků staví na [[topics/12-3d-transformace-pipeline|grafické pipeline]]; MVC a události se uplatňují i ve [[topics/37-webova-rozhrani-autentizace|webových rozhraních]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/12-3d-transformace-pipeline|12. Transformace 3D modelů]] · další: [[topics/14-spektralni-analyza|14. Spektrální analýza]] ▶

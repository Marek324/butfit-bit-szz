...
- **Link-State** (OSPF, IS-IS) — každý router zná **celou topologii** (flooding) → **Dijkstra** ([[topics/25-teorie-grafu]]).
...
Transportní/síťová vrstva viz [[topics/43-tcp-ip-komunikace]]; Dijkstra viz [[topics/25-teorie-grafu]]; TLS/JWT a autentizace viz [[topics/37-webova-rozhrani-autentizace]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/43-tcp-ip-komunikace|43. TCP/IP komunikace]] · konec přehledu

...
- Návrh přes [[topics/34-uml|UML]] (diagramy tříd), znovupoužití dědičností, override (polymorfismus), **ORM** pro ukládání do relační DB, **návrhové vzory** (Factory, Observer, Singleton, MVC).

Modelování v UML viz [[topics/34-uml]]; ADT a struktury viz [[topics/29-datove-ridici-struktury]]; OO ve vývoji viz [[topics/33-zivotni-cyklus-sw]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/39-planovani-synchronizace-procesu|39. Plánování a synchronizace procesů]] · další: [[topics/41-assembler|41. Programování v JSI (assembler)]] ▶

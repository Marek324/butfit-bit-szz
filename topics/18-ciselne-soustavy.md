...
- Záporná čísla: přímý / inverzní (jedničkový) / **doplňkový (dvojkový)** kód — viz [[topics/09-reprezentace-cisel-ieee754]].
...
- **Převod mezi dvojkovou a šestnáctkovou soustavou:** na zapsání všech šestnáctkových číslic stačí přesně **4 bity**. Stačí číslo rozdělit na **nibly** (čtveřice) a každý zapsat jako **šestnáctkovou číslici**, respektive z šestnáctkové číslice vytvářet **nibly** (čtveřice binárních číslic). (0001\|0011\|0010\|1010)₂ = (1\|3\|2\|A)₁₆ (8\|A\|F)₁₆ = (1000\|1010\|1111)₂
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/17-diferencialni-integralni-pocet|17. Diferenciální a integrální počet]] · další: [[topics/19-vyrokova-predikatova-logika|19. Výroková a predikátová logika]] ▶

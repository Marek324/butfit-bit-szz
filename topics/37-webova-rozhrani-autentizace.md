...
relationships:
  - target: "[[topics/36-relacni-data-sql-transakce]]"
    type: related_to
  - target: "[[topics/13-graficka-uzivatelska-rozhrani]]"
    type: related_to
...
Relační DB v pozadí viz [[topics/36-relacni-data-sql-transakce]]; principy GUI a MVC viz [[topics/13-graficka-uzivatelska-rozhrani]]; kryptografie pro JWT/TLS viz [[topics/44-smerovani-zabezpeceni-siti]]; HTTP jako služba viz [[topics/42-sluzby-aplikacni-vrstvy]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/36-relacni-data-sql-transakce|36. Strukturovaná data, SQL, transakce]] · další: [[topics/38-sprava-souboru-pameti|38. Správa souborů a paměti]] ▶

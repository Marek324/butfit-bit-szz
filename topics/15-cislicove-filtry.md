...
relationships:
  - target: "[[topics/14-spektralni-analyza]]"
    type: uses
...
- **Konvoluce** — výstup = konvoluce vstupu s impulsní odezvou; v časové doméně $O(n²)$, ve frekvenční doméně jen **násobení** (viz [[topics/14-spektralni-analyza|FFT]]).
...
Frekvenční analýza staví na [[topics/14-spektralni-analyza|Fourierově transformaci]]; rekurzivní struktury implementují zpožďovací články (klopné obvody, [[topics/03-sekvencni-logicke-obvody]]).
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/14-spektralni-analyza|14. Spektrální analýza]] · další: [[topics/16-mnoziny-relace-zobrazeni|16. Množiny, relace a zobrazení]] ▶

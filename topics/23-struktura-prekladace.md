...
- **LA**: text → **tokeny** (lexémy klasifikované, s atributy); založena na **regulárních výrazech** a **DKA** ([[topics/21-regularni-jazyky]]); komunikuje s **tabulkou symbolů**.
- **SA**: tokeny → simulace **derivačního stromu**; deterministické **zásobníkové automaty** ([[topics/22-bezkontextove-jazyky]]), podmnožiny BKG: **LL** a **LR**.
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/22-bezkontextove-jazyky|22. Bezkontextové jazyky]] · další: [[topics/24-numericke-metody|24. Numerické metody]] ▶

...
relationships:
  - target: "[[topics/33-zivotni-cyklus-sw]]"
    type: related_to
...
- **Diagram aktivit** (vývojový diagram — větvení, paralelní toky), **stavový diagram** (životní cyklus objektu ~ [[topics/03-sekvencni-logicke-obvody|stavový automat]]).
...
UML v procesu vývoje viz [[topics/33-zivotni-cyklus-sw|RUP]]; ER × diagram tříd viz [[topics/35-konceptualni-modelovani-db]]; OO koncepty viz [[topics/40-objektova-orientace]].
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/33-zivotni-cyklus-sw|33. Životní cyklus softwaru]] · další: [[topics/35-konceptualni-modelovani-db|35. Konceptuální modelování a návrh DB]] ▶

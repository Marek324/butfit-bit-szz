...
relationships:
  - target: "[[topics/16-mnoziny-relace-zobrazeni]]"
    type: related_to
  - target: "[[topics/08-minimalizace-logickych-vyrazu]]"
    type: related_to
...
- Souvisí s [[topics/16-mnoziny-relace-zobrazeni|uspořádáním a svazy]] (Hasseův diagram, reflexivita/antisymetrie/tranzitivita).
...
- **Shefferova (NAND, ↑)** i **Peirceova (NOR, ↓)** funkce jsou samostatně **funkčně úplné** — vyjádří všechny ostatní (využití v [[topics/01-polovodicove-prvky-cmos|CMOS]]).
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/19-vyrokova-predikatova-logika|19. Výroková a predikátová logika]] · další: [[topics/21-regularni-jazyky|21. Regulární jazyky]] ▶

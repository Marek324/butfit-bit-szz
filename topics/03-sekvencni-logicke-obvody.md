...
> SZZ okruh 3 (FIT BUT). **Sekvenční obvod** = [[topics/02-kombinacni-logicke-obvody|kombinační]] část + **paměť**; výstup závisí na vstupech i na **vnitřním stavu**. Synchronní (řízené CLK) × asynchronní.
...
Klopný obvod z **2 PMOS + 4 NMOS** uchovává 1 bit — rychlá paměť pro registry a [[topics/04-hierarchie-pameti|cache]] (L1–L3).
...
Automaty se realizují i ve [[topics/10-fpga-vhdl|FPGA]] a jsou základem [[topics/21-regularni-jazyky|konečných automatů]] v teorii jazyků.
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[topics/02-kombinacni-logicke-obvody|2. Kombinační logické obvody]] · další: [[topics/04-hierarchie-pameti|4. Hierarchie paměti]] ▶

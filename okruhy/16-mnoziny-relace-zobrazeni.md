...
relationships:
  - target: "[[okruhy/20-boolovy-algebry]]"
    type: related_to
  - target: "[[okruhy/19-vyrokova-predikatova-logika]]"
    type: related_to
...
Souvisí s [[okruhy/20-boolovy-algebry]] (svazy, uspořádání), s formálním zápisem v [[okruhy/19-vyrokova-predikatova-logika]] a s [[okruhy/25-teorie-grafu]] (relace ↔ graf).
...
Rozkladem množin vznikne **systém množin** (množina množin), kde sjednocením jejích prvků získáme původní rozloženou množinu a zároveň pokud pro libovolné dva prvky rozkladu platí **X ∩ Y != ∅, pak X = Y**.\
...
- **Symetrická diference** (**symetrický rozdíl**): symetrická diference nebo symetrický rozdíl dvou množin označuje taková množina, která obsahuje všechny prvky z obou množin, které nejsou v jejich průniku. Značení:

  - 
![[media/szz-16/media/image4.png]]
, 
![[media/szz-16/media/image10.png]]
, 
![[media/szz-16/media/image18.png]]
...
![[media/szz-16/media/image15.png]]

![[media/szz-16/media/image16.png]]
...
- **Reflexivní**: reflexivní uzávěr binární relace **R** na množině **X** je nejmenší reflexivní relace **S** na množině X obsahující relaci **R** .\
  Např.: X = {1, 2, 3}, R = {(1, 1), (2, 3)}, S = {(1, 1), (2, 2), (3, 3), (2, 3)} 
![[media/szz-16/media/image2.png]]


- **Symetrický**: symetrický uzávěr binární relace **R** na množině **X** je nejmenší symetrická relace **S** na množině **X** obsahující relaci **R**.\
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[okruhy/15-cislicove-filtry|15. Číslicové filtry]] · další: [[okruhy/17-diferencialni-integralni-pocet|17. Diferenciální a integrální počet]] ▶

...
relationships:
  - target: "[[okruhy/21-regularni-jazyky]]"
    type: extends
  - target: "[[okruhy/23-struktura-prekladace]]"
    type: related_to
...
> SZZ okruh 22 (FIT BUT). Silnější třída než [[okruhy/21-regularni-jazyky|regulární jazyky]] — gramatika + zásobníkový automat.
...
- ZA/RZA **simulují konstrukci derivačního stromu** pro [[okruhy/23-struktura-prekladace|syntaktickou analýzu]] (shora dolů = expanze, zdola nahoru = shift/redukce).
...
---
**Navigace:** [[index|📋 Přehled okruhů]] · ◀ [[okruhy/21-regularni-jazyky|21. Regulární jazyky]] · další: [[okruhy/23-struktura-prekladace|23. Struktura překladače]] ▶

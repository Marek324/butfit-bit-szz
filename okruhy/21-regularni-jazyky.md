...
> L = L1•L2 = {xy: x ∈ L1 a y ∈ L2 }. Například\
> **L = L1•L2 = {0, 1}•{2, 3} = {02, 03, 12, 13}.**

- **Pozor:** Stejně jako při násobení můžeme konkatenační operátor (**•**) někdy vynechat: L<sub>1</sub>•L<sub>2</sub> = L<sub>1</sub>L<sub>2</sub>.
...
Převod nedeterministického KA na deterministický. Pokud má nedeterministický KA **n stavů**, má jeho deterministická varianta nejvíce **2<sup>n</sup> stavů**. Každý nedeterministický automat má svoji deterministickou variantu. Postup:

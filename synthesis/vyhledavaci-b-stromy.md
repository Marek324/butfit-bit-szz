...
sources: ["okruhy/29-datove-ridici-struktury.md", "okruhy/30-vyhledavani-razeni.md", "okruhy/38-sprava-souboru-pameti.md", "okruhy/04-hierarchie-pameti.md"]
...
- **[[okruhy/29-datove-ridici-struktury|okruh 29]]** — binární strom jako **ADT**; vyvažování (AVL, red-black) drží O(log n) a brání degradaci na seznam.
- **[[okruhy/30-vyhledavani-razeni|okruh 30]]** — **BVS** pro vyhledávání a **stromy s více klíči ve vrcholech (B/B+)**, které snižují výšku.
- **[[okruhy/38-sprava-souboru-pameti|okruh 38]]** — **B+ stromy** jako reálná organizace souborů/DB **na disku**.
...
- V RAM ([[okruhy/04-hierarchie-pameti|okruh 4]]) je náhodný přístup levný → stačí **binární** strom (vyvážený AVL/red-black).
